...
print(" Current Version is v1.13 2024")
...
def TestAngle(Alpha,D_zero,Prec):
 global Ytph,h,bullet,NS,Az_d,Az,Co,Ws,Wa_o,m_gr,montage,rifle,Shoot_Atm,Gamma,ICAO_Atm,Omega,SoundSpeed_ICAO,zero

 ta=0

 RK(D_zero,h,bullet.MuzzleSpeed,NS,Az_d,Az,Co,Ws,Wa_o,m_gr,montage.SightHeight,rifle.Twist,rifle.T_cal,rifle.Twist_C,rifle.Rifle_Brand,rifle.Rifle_Model,rifle.d_i,bullet.bl_cal,Alpha,zero.atm.Alt,Gamma,ICAO_Atm.Alt,ICAO_Atm.P,ICAO_Atm.T_C,ICAO_Atm.T_K,ICAO_Atm.RH,ICAO_Atm.Rho,ICAO_Atm.PVS,ICAO_Atm.PV,ICAO_Atm.TV,zero.atm.P,zero.atm.T_C,zero.atm.T_K,zero.atm.RH,zero.atm.Rho,zero.atm.PVS,zero.atm.PV,zero.atm.TV,Omega,SoundSpeed_ICAO)
...
# Atmopspheric values provided by Kestrel
