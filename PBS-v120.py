...
def PRS_Solver(D_Tir,h,MuzzleSpeed,NS,Az_d,Az,Co,m_gr,SightHeight,Twist,T_cal,Twist_C,Rifle_Brand,Rifle_Model,d_i,bl_cal,alpha_d,Alt,Gamma,Alt_ICAO,P_ICAO,T_C_ICAO,T_K_ICAO,RH_ICAO,Rho_ICAO,PVS_ICAO,PV_ICAO,TV_ICAO,P,T_C,T_K,RH,Rho,PVS,PV,TV,Omega,SoundSpeed_ICAO):
    ...
    global H_Angle_d,H_Angle,Ytph,tph,Vmod,SD,Sg,Shoot_Wind,bullet,Ytph_HA,Ytph_HA_Co,Ytph_Co,Ytph_NoHa_NoCo,impact,impact_HA,impact_HA_Co,impact_Co,impact_NoHa_NoCo,D_Tir_HA,Arrow
    ...
    if H_Angle_d == 0:
        ...
        if Co == "Y":
#        print("Impact Coriolis without HA")
...
#        print("Impact No Coriolis without HA")
...
#        impact.show()
        ...
        if Co == "N":
#        print("Impact HA without Coriolis")
...
Y_a_NoHa_NoCo=float((math.atan(impact_NoHa_NoCo.Y/D_Tir)*1000))
Y_a_NoHa_Co=float((math.atan(impact_Co.Y/D_Tir)*1000))
Y_a_NoC=float((math.atan(impact_HA.Y/D_Tir)*1000))
Y_a_Ha_Co=float((math.atan(impact_HA_Co.Y/D_Tir)*1000))
...
print("Windage to be applied due to due to Cross Wind (clicks) :",round(-(Wind_CW_a/c_mRAD),1))

W_c+=-(Wind_CW_a/c_mRAD)
...
#        Y_a_Co=Y_a_Co+(math.atan(Delta_Y_Drop/D_Tir)*1000)
    ...
    Partial_E=float(Total_E-(math.atan(Delta_Y_Drop/D_Tir)*1000/c_mRAD))
