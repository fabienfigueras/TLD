...
print(" Current Version is v1.07 2024")
...
def RK(D_Tir,h,MuzzleSpeed,NS,Az_d,Az,Co,Ws,Wa_o,m_gr,SightHeight,Twist,T_cal,Twist_C,Rifle,d_i,bl_cal,alpha_d,Alt,Gamma,Alt_ICAO,P_ICAO,T_C_ICAO,T_K_ICAO,RH_ICAO,Rho_ICAO,PVS_ICAO,PV_ICAO,TV_ICAO,P,T_C,T_K,RH,Rho,PVS,PV,TV,Omega,SoundSpeed_ICAO):
    ...
    global E_c,W_c,tph,Vxtph,Vytph,Vztph,Sg,WDx,WDy,Wsx,Wsy,Wsz,V0,Lat_D,Vmod,Xtph,Ytph,Ztph
...
print("Shooting Angle relative to Horizontal plan (deg) : ",H_Angle_d," (RAD) : ",H_Angle)
...
print("======================")
print("Aerodynamic Jump ")
print("======================")
print("Aerodynamic Jump : ",AJ)

if AJ == "N":
    print("Aerodynamic Jump = N Effect NOT taken into account")
else:
    print("Aerodynamic Jump = Y Effect taken into account")
...
if H_Angle_d == 0:
    ...
    RK(D_Tir_HA,h,MuzzleSpeed,NS,Az_d,Az,Co,Ws,Wa_o,m_gr,SightHeight,Twist,T_cal,Twist_C,Rifle,d_i,bl_cal,alpha_d,Alt,Gamma,Alt_ICAO,P_ICAO,T_C_ICAO,T_K_ICAO,RH_ICAO,Rho_ICAO,PVS_ICAO,PV_ICAO,TV_ICAO,P,T_C,T_K,RH,Rho,PVS,PV,TV,Omega,SoundSpeed_ICAO)
    Ytph_HA=float(Ytph)
    RK(D_Tir,h,MuzzleSpeed,NS,Az_d,Az,Co,Ws,Wa_o,m_gr,SightHeight,Twist,T_cal,Twist_C,Rifle,d_i,bl_cal,alpha_d,Alt,Gamma,Alt_ICAO,P_ICAO,T_C_ICAO,T_K_ICAO,RH_ICAO,Rho_ICAO,PVS_ICAO,PV_ICAO,TV_ICAO,P,T_C,T_K,RH,Rho,PVS,PV,TV,Omega,SoundSpeed_ICAO)
    print("======================")
...
if H_Angle_d == 0:
    ...
    Y_a=float((Ytph_HA*1000)/D_Tir_HA)
...
if AJ == "N":
    AJE=float(0)
print("Calculated Y shift due to Aerodynamic Jump (m) :",round((AJE),2)," (cm) :",round((AJE)*100,2))
print("Calculated Y Angle due to Aerodynamic Jump (mRAD) :",round(float(((AJE)*1000)/D_Tir),2))
if AJ == "Y":
