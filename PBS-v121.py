...
def Zeroing(D_zero,Prec):
    ...
    PRS_Solver(D_zero,h,bullet.MuzzleSpeed,NS,Az_d,Az,Co,bullet.m_gr,montage.SightHeight,rifle.Twist,rifle.T_cal,rifle.Twist_C,rifle.Rifle_Brand,rifle.Rifle_Model,bullet.d_i,bullet.bl_cal,float(0),Shoot_Atm.Alt,Gamma,ICAO_Atm.Alt,ICAO_Atm.P,ICAO_Atm.T_C,ICAO_Atm.T_K,ICAO_Atm.RH,ICAO_Atm.Rho,ICAO_Atm.PVS,ICAO_Atm.PV,ICAO_Atm.TV,Shoot_Atm.P,Shoot_Atm.T_C,Shoot_Atm.T_K,Shoot_Atm.RH,Shoot_Atm.Rho,Shoot_Atm.PVS,Shoot_Atm.PV,Shoot_Atm.TV,Omega,SoundSpeed_ICAO)

#    print("Zeroed Ytph :", Ytph)
#    impact.show()
...
#    Alpha_RAD=float(-math.atan(Ytph/D_zero))
    Alpha_RAD_1=float(-math.atan(impact.Y/D_zero))

#    print("Passe 1 : Corrections en Elevation pour le Zero: ", (Alpha_RAD_1*1000/c_mRAD))

    Alpha_d_1=float(Alpha_RAD_1*180/math.pi)

    PRS_Solver(D_zero,h,bullet.MuzzleSpeed,NS,Az_d,Az,Co,bullet.m_gr,montage.SightHeight,rifle.Twist,rifle.T_cal,rifle.Twist_C,rifle.Rifle_Brand,rifle.Rifle_Model,bullet.d_i,bullet.bl_cal,Alpha_d_1,Shoot_Atm.Alt,Gamma,ICAO_Atm.Alt,ICAO_Atm.P,ICAO_Atm.T_C,ICAO_Atm.T_K,ICAO_Atm.RH,ICAO_Atm.Rho,ICAO_Atm.PVS,ICAO_Atm.PV,ICAO_Atm.TV,Shoot_Atm.P,Shoot_Atm.T_C,Shoot_Atm.T_K,Shoot_Atm.RH,Shoot_Atm.Rho,Shoot_Atm.PVS,Shoot_Atm.PV,Shoot_Atm.TV,Omega,SoundSpeed_ICAO)

    Alpha_RAD_2=float(-math.atan(impact.Y/D_zero))

#    print("Passe 2 Corrections en Elevation pour le Zero : ", (Alpha_RAD_2*1000/c_mRAD))

    Alpha_d_2=float(Alpha_RAD_2*180/math.pi)

    Alpha_d=Alpha_d_1+Alpha_d_2
    ...
    Alpha_RAD_3=float(-math.atan(impact.Y/D_zero))

#    print("Passe 3 Corrections en Elevation pour le Zero : ", (Alpha_RAD_3*1000/c_mRAD))
