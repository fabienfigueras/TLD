...
# Objects and variable First initialization
...
#    print("Data from file :",FNmontage)
    ...
    montage.FixedAngle_d=(float(DL[1])/1000)*(180/math.pi)
#    montage.show()
    fh.close()
...
def ResetData():
    global bullet,D_Tir,Az_d,Co,Ws,Wa_o,SD_p,h,Zero_C,H_Angle_d,H_Angle,AJ,BC_Gx,BC_Go,E_c,W_c,tph,Vxtph,Vytph,Vztph,SD,Sg,AJ_MOA,AJ_mRAD,AJD_z,AJE,WDx,WDy,Wsx,Wsy,Wsz,Lat_d,Lat_m,Lat_s,Lat_D,NS,Az,Vmod,Xtph,Ytph,Ztph,Gamma,D_Tir_HA,Ytph_HA,Y_max,XY_max,TY_max,Arrow,ICAO_Atm,SoundSpeed_ICAO,Shoot_Atm,Omega
...
def TestAngle(Alpha,D_zero,Prec):
 ...
 RK(D_zero,h,bullet.MuzzleSpeed,NS,Az_d,Az,Co,Ws,Wa_o,bullet.m_gr,montage.SightHeight,rifle.Twist,rifle.T_cal,rifle.Twist_C,rifle.Rifle_Brand,rifle.Rifle_Model,rifle.d_i,bullet.bl_cal,Alpha,zero.atm.Alt,Gamma,ICAO_Atm.Alt,ICAO_Atm.P,ICAO_Atm.T_C,ICAO_Atm.T_K,ICAO_Atm.RH,ICAO_Atm.Rho,ICAO_Atm.PVS,ICAO_Atm.PV,ICAO_Atm.TV,zero.atm.P,zero.atm.T_C,zero.atm.T_K,zero.atm.RH,zero.atm.Rho,zero.atm.PVS,zero.atm.PV,zero.atm.TV,Omega,SoundSpeed_ICAO)
...
def RK(D_Tir,h,MuzzleSpeed,NS,Az_d,Az,Co,Ws,Wa_o,m_gr,SightHeight,Twist,T_cal,Twist_C,Rifle_Brand,Rifle_Model,d_i,bl_cal,alpha_d,Alt,Gamma,Alt_ICAO,P_ICAO,T_C_ICAO,T_K_ICAO,RH_ICAO,Rho_ICAO,PVS_ICAO,PV_ICAO,TV_ICAO,P,T_C,T_K,RH,Rho,PVS,PV,TV,Omega,SoundSpeed_ICAO):
    ...
    global E_c,W_c,tph,Vxtph,Vytph,Vztph,Sg,WDx,WDy,Wsx,Wsy,Wsz,bullet,Lat_D,Vmod,Xtph,Ytph,Ztph,Arrow,Y_max,XY_max,TY_max,BC_Gx,BC_Go
    ...
    Vx=float(bullet.V0*math.cos(alpha))
...
def PRS_Solver(D_Tir,h,MuzzleSpeed,NS,Az_d,Az,Co,Ws,Wa_o,m_gr,SightHeight,Twist,T_cal,Twist_C,Rifle_Brand,Rifle_Model,d_i,bl_cal,alpha_d,Alt,Gamma,Alt_ICAO,P_ICAO,T_C_ICAO,T_K_ICAO,RH_ICAO,Rho_ICAO,PVS_ICAO,PV_ICAO,TV_ICAO,P,T_C,T_K,RH,Rho,PVS,PV,TV,Omega,SoundSpeed_ICAO):

    global H_Angle_d,H_Angle,Ytph,tph,Vmod,SD,Sg,WDx,WDy,WDz,Wsx,Wsy,Wsz,bullet,Ytph_HA
...
WDy=float(Wsy*(tph-(round(D_Tir,0)/bullet.V0)))
WDz=float(Wsz*(tph-(round(D_Tir,0)/bullet.V0)))
...
print("Windage correction depending on Spin Drift (clicks) :",round(W_SpinDrift,0))
A_AJ=AJE
...
if H_Angle_d == 0:
    RK(D_Tir,h,bullet.MuzzleSpeed,NS,Az_d,Az,Co,Ws,Wa_o,bullet.m_gr,montage.SightHeight,rifle.Twist,rifle.T_cal,rifle.Twist_C,rifle.Rifle_Brand,rifle.Rifle_Model,rifle.d_i,bullet.bl_cal,zero.alpha_d,Shoot_Atm.Alt,Gamma,ICAO_Atm.Alt,ICAO_Atm.P,ICAO_Atm.T_C,ICAO_Atm.T_K,ICAO_Atm.RH,ICAO_Atm.Rho,ICAO_Atm.PVS,ICAO_Atm.PV,ICAO_Atm.TV,Shoot_Atm.P,Shoot_Atm.T_C,Shoot_Atm.T_K,Shoot_Atm.RH,Shoot_Atm.Rho,Shoot_Atm.PVS,Shoot_Atm.PV,Shoot_Atm.TV,Omega,SoundSpeed_ICAO)
else:
    D_Tir_HA=D_Tir*math.cos(H_Angle)
    RK(D_Tir_HA,h,bullet.MuzzleSpeed,NS,Az_d,Az,Co,Ws,Wa_o,bullet.m_gr,montage.SightHeight,rifle.Twist,rifle.T_cal,rifle.Twist_C,rifle.Rifle_Brand,rifle.Rifle_Model,rifle.d_i,bullet.bl_cal,zero.alpha_d,Shoot_Atm.Alt,Gamma,ICAO_Atm.Alt,ICAO_Atm.P,ICAO_Atm.T_C,ICAO_Atm.T_K,ICAO_Atm.RH,ICAO_Atm.Rho,ICAO_Atm.PVS,ICAO_Atm.PV,ICAO_Atm.TV,Shoot_Atm.P,Shoot_Atm.T_C,Shoot_Atm.T_K,Shoot_Atm.RH,Shoot_Atm.Rho,Shoot_Atm.PVS,Shoot_Atm.PV,Shoot_Atm.TV,Omega,SoundSpeed_ICAO)
...
if sys.argv[16] == "Y":
    ...
    FNabacus= "./Abacus-"+str(int(bullet.d_i*1000))+"_"+amo.Amo_Brand+"_"+str(int(bullet.m_gr))+"_"+str(int(D_Tir))+".html"
    ...
    Ligne1="PBS v"+PBS_version+" "+PBS_year+" Generic Abacus - "+str(int(bullet.d_i*1000))+"(inch) "+str(int(bullet.m_gr))+"(gr) "+" Bullet - "+bullet.Bullet_Brand+" "+bullet.Bullet_Model+" Rifle Bore "+rifle.Twist_C+"Twist 1:"+str(round(rifle.Twist,0))+" (inch) - Muzzle Speed "+str(int(bullet.MuzzleSpeed))+" (m/s) in ICAO Atmosphere "+"- Sight Height : "+str(montage.SightHeight*1000)+" (mm)"
...
#            print("Distance for Simulation (m)",round(A_D_Tir_HA,1))
            ...
            PRS_Solver(A_D_Tir_HA,h,bullet.MuzzleSpeed,NS,Az_d,Az,Co,Ws,Wa_o,bullet.m_gr,montage.SightHeight,rifle.Twist,rifle.T_cal,rifle.Twist_C,rifle.Rifle_Brand,rifle.Rifle_Model,bullet.d_i,bullet.bl_cal,zero.alpha_d,Shoot_Atm.Alt,Gamma,ICAO_Atm.Alt,ICAO_Atm.P,ICAO_Atm.T_C,ICAO_Atm.T_K,ICAO_Atm.RH,ICAO_Atm.Rho,ICAO_Atm.PVS,ICAO_Atm.PV,ICAO_Atm.TV,Shoot_Atm.P,Shoot_Atm.T_C,Shoot_Atm.T_K,Shoot_Atm.RH,Shoot_Atm.Rho,Shoot_Atm.PVS,Shoot_Atm.PV,Shoot_Atm.TV,Omega,SoundSpeed_ICAO)
            ...
            WDy=float(Wsy*(tph-(round(A_D_Tir,0)/bullet.V0)))
            WDz=float(Wsz*(tph-(round(A_D_Tir,0)/bullet.V0)))
...
#        print("==============================")
    ...
    AbacusFile.write("\t<tr>\n")
    AbacusFile.write("\t\t<th colspan=\"16\">")
    Ligne2000="How to use this Abacus ? Let's say you shoot at a target located at "+str(int(round(D_Tir,0)))+" m away."+" The correction (# of click, 1 click = 0.1 mRAD) to be applied on the Elevation knob is basically the number just after the = sign on the right of the distance" + ", add or substract the number under the corresponding vertical angle. " + ", add or substract the number under the corresponding local pressure. " + ", add or substract the number under the corresponding local Temperature. "
